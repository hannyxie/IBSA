...
class BSRPage(QTabWidget):
    ...
    def clean_df(self):
        ...
        self.df = df[['CHROM', 'POS', 'REF', 'ALT','pool_1_gt','pool_1_snp_index','pool_2_gt','pool_1_snp_index','ed6']]
    ...
    def slide_window(self):
        ...
        def get_slide_index(chrom,window_start,window_end,df):
            ...
            if data_df.shape[0] > n_snp:
                ...
                slide_index =None
            return slide_index
        df_window['slide_ed6']=df_window.apply(lambda x: get_slide_index(x.chrom,x.window_start,x.window_end,df),axis = 1)
